...
public class ModerationController {
    ...
    public ResponseEntity<List<Moderation>> getModerationsByPublication(@PathVariable int publicationId) {
        List<Moderation> moderations = moderationService.getModerationsByPublication(publicationId);
    ...
    public ResponseEntity<List<Moderation>> getModerationsByUser(@PathVariable int userId) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Moderation> getModerationById(@PathVariable int id) {
